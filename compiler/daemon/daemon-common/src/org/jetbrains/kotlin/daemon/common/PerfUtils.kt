...
class WallAndThreadTotalProfiler : TotalProfiler() {
    override fun beginMeasure(obj: Any?) = beginWithMeasureWallAndThreadTimes(total, threadMXBean)
    override fun endMeasure(obj: Any?, startState: List<Long>) = endWithMeasureWallAndThreadTimes(total, threadMXBean, startState)
}


class WallAndThreadAndMemoryTotalProfiler(val withGC: Boolean) : TotalProfiler() {
    override fun beginMeasure(obj: Any?) =
        beginWithMeasureWallAndThreadTimesAndMemory(total, withGC, threadMXBean)
    override fun endMeasure(obj: Any?, startState: List<Long>) =
